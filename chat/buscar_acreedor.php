...
include './controller/controller_provedor.php';
...
$resultado = $datos_sql->select_datos_proveedor($cedula);
...
if (empty($resultado) || !isset($resultado[0]) || !isset($resultado[0]['cedula'])) {
    echo "<p>No hemos encontrado ninguna acreencia registrada a su nombre en los fideicomisos administrados.</p>";
