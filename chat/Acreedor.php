...
<div id="content">
    ...
    <div class="logo-container">
        ...
        <p class="titulo-ACREEDOR">ACREEDOR</p>
    </div>
        ...
        <tr>
            <td colspan="3">
                <p align="justify" style="font-family: verdana; font-size:12px">
                    ...
                    ¿Es Acreedor de las cooperativas liquidadas y actualmente extintas que constituyeron fideicomiso en la CONAFIPS? 
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function realizarConsulta() {
            ...
            xhr.open('POST', 'buscar_acreedor.php', true);
